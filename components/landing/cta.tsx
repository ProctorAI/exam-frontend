    ...
    <section className="py-20 sm:py-24 lg:py-32">
      ...
      >
        <h2 className="mx-auto max-w-4xl text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
          Transform Your{" "}
          <span className="text-primary dark:text-primary/90">Online Examinations</span>
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:mt-8">
          Join thousands of institutions using ProctorAI to conduct secure and efficient online examinations
        </p>
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg text-muted-foreground">
                Get the latest updates about ProctorAI features
              </p>
            </div>
